...
function App() {
  ...
  useEffect(()=>{
    if(weatherData && filteredData[0] && input === filteredData[0].name){
      ...
      const sentence =
        "Give suggestions for what to wear today given the following weather data in my city. The temperature data given are in kelvins,so in your response please convert any temperature you use into celsius without any decimal places. Give a summary and 3-5 suggestions in bullet points." +
